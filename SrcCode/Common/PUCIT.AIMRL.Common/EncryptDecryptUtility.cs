...
namespace PUCIT.AIMRL.Common
{
    ...
    {
        private static string passPhrase = "aBcDeFgHiJKLMnoPQrSTu";
        private static string saltValue = "123456787912345891234";
        private static string hashAlgorithm = "MD5";
        private static int passwordIterations = 50;
        private static string initVector = "1234512345124512";
